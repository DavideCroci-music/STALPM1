...
online, %con opzione di utilizzo su varie piattaforme, sia tramite sito web che su diverse piattaforme, in modo che fosse
ma utilizzabile anche offline. In aggiunta l'idea di approfondire nuove
...
Il filtro scelto per operare sul suono del generatore è della tipologia \emph{passa basso}
ovvero un filtro in grado di modificare le caratteristiche spettrali dei suoni
eliminando, filtrando, bande indesiderate; un filtro
modifica quindi l’ampiezza e la fase di un segnale che passi attraverso di esso,
senza alterare la frequenza di alcuna componente spettrale del segnale stesso.
...
\subsection*{Larghezza di banda Q}
...
\begin{lstlisting}
declare filename "Superstereosynth.dsp";
declare name "Superstereosynth";
